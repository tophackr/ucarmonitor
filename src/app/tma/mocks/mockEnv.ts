...
export async function mockEnv(isDev: boolean) {
    ...
    mockTelegramEnv({
        onEvent([e]) {
            ...
            if (e === 'web_app_request_safe_area') {
        ...
        launchParams: new URLSearchParams([
            ...
            // ```
            // user=%7B%22id%22%3A279058397%2C%22first_name%22%3A%22Alexandr%22%2C%22last_name%22...
            // ```
            ...
            [
                ...
                new URLSearchParams([
                    ...
                    ['user', JSON.stringify({ id: 1, first_name: 'Alexandr' })]
                ]).toString()
            ],
            ['tgWebAppVersion', '8.4'],
